#####################################################################################
###
### Script for creating Supplementary High School/PSAT Maine_Data_LONG_2012_2013
###
#####################################################################################
...
tmp.psat1011 <- read.delim("Data/Base_Files/ME_DOE_PN_admin_match_2010.txt", header=TRUE)
tmp.psat1112 <- read.delim("Data/Base_Files/ME_DOE_PN_admin_match_2011.txt", header=TRUE)
tmp.psat1213 <- read.delim("Data/Base_Files/ME_DOE_PN_admin_match_2012.txt", header=TRUE)
tmp.mhsa1112 <- read.csv("Data/Base_Files/MHSA1112StateStudentScoredDataHS.csv", header=TRUE)
tmp.mhsa1213 <- read.csv("Data/Base_Files/MHSA1213StateStudentScoredDataHS.csv", header=TRUE)
...
#######################################################################
### Clean up PSAT/SAT data
#######################################################################

names(tmp.psat1011) <- toupper(names(tmp.psat1011))
names(tmp.psat1112) <- toupper(names(tmp.psat1112))
names(tmp.psat1213) <- toupper(names(tmp.psat1213))
